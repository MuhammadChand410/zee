...
//                     <div className="">
//                         {PRODUCT_LINKS.map((card =>
//                             <Link to={card.path} key={card.id} className="px-4 py-4 hover:bg-[#F3FE0014] rounded-xl flex items-center gap-3">
//                                 <div className="flex shrink-0">
//                                     <card.icon />
//                                 </div>
//                                 <h2 className="text-base font-[Inter] font-semibold text-white">{card.title}</h2>
//                             </Link>
//                         ))}
//                     </div>

//                     <div className="grid md:grid-cols-2 grid-cols-1 pb-0 md:pb-15 gap-6">
//                         {PRODUCT_CARDS.map((card =>
//                             <div className="flex  gap-3 px-5 py-3 hover:bg-[#F3FE0014] rounded-xl" key={card.id}>
//                                 <div className="flex shrink-0">
//                                     <card.icon />
//                                 </div>
//                                 <div className="">
//                                     <h3 className="text-base pb-1 text-white font-semibold font-[Inter]">{card.title}</h3>
//                                     <p className="text-sm font-normal leading-[24px] text-white font-[Inter]">{card.desc}</p>
//                                 </div>
//                             </div>
//                         ))}
//                     </div>
