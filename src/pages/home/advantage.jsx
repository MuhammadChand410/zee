// import { AdvantageImage } from "../../assets/images";
...
//                         <HeroContant subheading='Our process, Your Advantage' classNameSub='!pb-4' heading='From Idea To Execution' classNamehead='!pb-4' desc='We have become experts in creating top-notch digital products. We design beautifully and
//                             develop excellently. And we care deeply about what we do.' classNameDesc='!max-w-[596px]' />
//                     </div>
//                     <div className="grid md:grid-cols-2 grid-cols-1 gap-8 sm:gap-20">
//                         <div className="grid sm:gap-25 gap-8">
//                             {ADVANTAGE_CARD.map((card =>
//                                 <div className="grid gap-4" key={card.id}>
//                                     <div className="grid gap-1.5">
//                                         <h2 className="sm:text-4xl text-xl font-semibold text-[#8F8F8F]">{card.title}</h2>
//                                         <p className="text-base sm:text-lg font-normal text-white/60">{card.sub}</p>
//                                     </div>
//                                     <p className="sm:text-base font-normal text-white/60 sm:leading-[24px] leading-[21px]">{card.desc}</p>
//                                 </div>
//                             ))}
//                         </div>
...
//                                 <img src={AdvantageImage} alt="advantage-image" width={527} height={506} loading="lazy"
//                                     className="w-[527px] h-[506px] object-cover rounded-2xl"
//                                 />
//                             </div>
//                         </div>
//                     </div>
...
import { AdvantageImage, ProcessFive, ProcessFour, ProcessOne, ProcessSix, ProcessThree, ProcessTwo } from "../../assets/images";
import HeroContant from "../../component/common/hero-contant/hero-contant";
