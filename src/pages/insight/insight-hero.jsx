            ...
            <div className="container">
                ...
                <div className="grid gap-8">
                    ...
                    <div className="flex justify-center">
                        <div className="flex justify-between w-[300px] md:w-[364px] items-center border border-[#2D2D2D] rounded-full  py-1.5 pl-6 pr-1.5" style={{ background: "rgba(255, 255, 255, 0.10)" }}>
                            <input type="search" name="" id="" placeholder="Search Any Insights" className="text-[#FFF] text-base font-normal outline-none" style={{ opacity: "0.6" }} />
